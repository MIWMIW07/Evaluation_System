<?php
// google_drive_reports.php - Complete implementation with individual and summary reports
...
class GoogleDriveReportsGenerator {
    ...
    private function populateProgramSummaryReport($spreadsheetId, $teacherName, $program, $stats, $commentsAnalysis, $totalEvaluations) {
        $reportData = [
            ...
            ['Positive Comments', $commentsAnalysis['positive'], number_format(($commentsAnalysis['positive']/$commentsAnalysis['total'])*100, 1) . '%'],
            ['Negative Comments', $commentsAnalysis['negative'], number_format(($commentsAnalysis['negative']/$commentsAnalysis['total'])*100, 1) . '%'],
            ['Neutral Comments', $commentsAnalysis['neutral'], number_format(($commentsAnalysis['neutral']/$commentsAnalysis['total'])*100, 1) . '%'],
